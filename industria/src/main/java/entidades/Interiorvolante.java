 ...
 */
@Entity
@Table(name = "interiorvolante")
@NamedQueries({
    @NamedQuery(name = "Interiorvolante.findAll", query = "SELECT i FROM Interiorvolante i"),
    @NamedQuery(name = "Interiorvolante.findById", query = "SELECT i FROM Interiorvolante i WHERE i.id = :id"),
    @NamedQuery(name = "Interiorvolante.findByStatusinterior", query = "SELECT i FROM Interiorvolante i WHERE i.statusinterior = :statusinterior")})
public class Interiorvolante implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        Interiorvolante other = (Interiorvolante) object;
    ...
    public String toString() {
        return "entidades.Interiorvolante[ id=" + id + " ]";
    }
